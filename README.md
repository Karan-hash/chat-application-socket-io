...
```
cd existing_repo
git remote add origin https://gitlab.fbr.group/karan/chat-whizz-application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fbr.group/karan/chat-whizz-application/-/settings/integrations)
